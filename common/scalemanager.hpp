...
class ScaleManager {
   ...
   * @see    String
   */
  std::string getChord(int interval);
   ...
   * 
   */
  std::string getNote(int interval);
   ...
   */
  std::vector<std::string> getRandomChords(int num_random_chords);
   ...
   * @throws InvalidNoteException 
   */
  std::uint8_t getInterval(NoteLetterType note);
  ...
  protected:
   ...
   NoteLetter scale;
   static constexpr int SCALE_NOTES = 8;
   int halfStepsMap[];
